...
## 简介
进制转换工具是 FeHelper 提供的数字进制转换工具，支持 2-36 进制之间的相互转换。v2026.04 升级为 **BigInt 引擎**，支持任意精度大数运算，彻底告别 JavaScript Number 的精度丢失问题。该工具提供了直观的界面和实时转换功能，帮助用户快速完成不同进制之间的转换工作。
