...
## 简介
二维码/条形码工具是 FeHelper 提供的多功能视觉编码工具。支持二维码的生成和解码功能，v2026.04 新增条形码生成，涵盖 Code128、EAN-13、EAN-8、UPC、ITF-14 等主流格式。该工具提供了直观的用户界面，让用户可以轻松地生成自定义二维码和条形码，也可以快速解码已有的二维码图片。
...
3. **输入提示**
   - 工具会根据所选格式自动提示正确的输入格式
   - 如输入不合规，会显示具体的错误原因和修正建议

## 更新日志
- 2026-04-13: 新增条形码生成（Code128/EAN-13/EAN-8/UPC/ITF-14），SVG/PNG导出
