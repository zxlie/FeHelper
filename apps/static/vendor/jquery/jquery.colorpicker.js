...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            ...
            +'<input type="text" id="DisColor" size="6" disabled style="border:solid 1px #000000;background-color:#ffff00">'
            +'<input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;padding:2px 16px" value="#000000"><a href="javascript:void(0);" id="_cclose">关闭</a> | <a href="javascript:void(0);" id="_creset">清除</a></td></table>'
