...
describe('json-format settings regression guards', () => {
    ...
    it('manual json-format page no longer silently inherits legacy nested-parse keys', () => {
        ...
        expect(css).toContain('.fh-json-tool.fh-json-tool-lite .fh-lite-sort-trigger');
        expect(css).toContain('.fh-json-tool.fh-json-tool-lite .fh-lite-sort-options');
        expect(css).toContain('.fh-json-tool.fh-json-tool-lite .fh-lite-sort-option input:checked + span');
